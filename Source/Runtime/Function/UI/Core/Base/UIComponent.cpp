...
namespace Erisu::Function
{
    ...
    Eigen::Matrix4f UIComponent::GetModelMatrix() const
    {
        ...
        Eigen::Vector2f scrPos = GetAnchorOffset() + (parent_.expired() ? Eigen::Vector2f::Zero()
                                                                        : parent_.lock()->GetCoordinatePosition());
...
//            model = gameObject_.lock()->GetTransform().GetModelMatrix() * model;
    ...
    void UIComponent::ShowInInspector()
    {
        ...
        ImGui::Combo("BlendMode", (int *) &AlphaBlend,
                     "Alpha\0Additive\0Multiply\0Screen\0Overlay\0Darken\0Lighten\0Disabled\0");
    }
