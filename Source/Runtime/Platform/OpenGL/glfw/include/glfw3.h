 ...
 *
 *  @analysis ErisuApp programmer error.  Initialize GLFW before calling any
 ...
 *
 *  @analysis ErisuApp programmer error.  Ensure a context is current before
 ...
 *
 *  @analysis ErisuApp programmer error.  Fix the offending call.
 */
